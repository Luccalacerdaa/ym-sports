...
const WHATSAPP_NUMBER = '5565996438395';
const WHATSAPP_MESSAGE = 'Olá! Preciso de ajuda com o YM Sports.';
  ...
  return (
    <div className="container max-w-2xl mx-auto px-4 py-6 space-y-6">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-2xl font-bold text-white text-base transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg"
